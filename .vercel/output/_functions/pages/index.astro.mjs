...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es"> <head><meta charset="UTF-8"><title>Infojobs Landing Practice</title><meta name="description" content="Usa InfoJobs e impulsa tu carrera trabajando en una empresa líder"><meta name="viewport" content="width=device-width"><meta property="twitter:image" content="https://primer-trabajo.infojobs.net/og.jpg"><meta property="twitter:card" content="summary_large_image"><meta property="twitter:title" content="Encuentra tu Primer Trabajo en InfoJobs"><meta property="twitter:description" content="Usa InfoJobs e impulsa tu carrera trabajando en una empresa líder"><meta property="og:image" content="https://primer-trabajo.infojobs.net/og.jpg"><meta property="og:site_name" content="InfoJobs.net"><meta property="og:title"${addAttribute(title, "content")}><meta property="og:description" content="Usa InfoJobs e impulsa tu carrera trabajando en una empresa líder"><meta property="og:url" content="https://primer-trabajo.infojobs.net/"><link rel="preload" as="image" href="/hero-pattern.webp"><link rel="shortcut icon" href="./assets/favicon.webp" type="image/x-icon">${renderHead()}</head>  ${renderComponent($$result, "Header", $$Header, {})} <main class="flex flex-col gap-20 md:gap-24"> ${renderSlot($$result, $$slots["default"])} </main> <div id="cmpContainer"></div> ${renderComponent($$result, "Footer", $$Footer, {})} </html>`;
